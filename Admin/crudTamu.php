...
if ($tambah == "tambah") {
	echo $namaTamu.$no.$alamat.$action;
 	mysqli_query($conn,"INSERT INTO tamuundangan VALUES('','$namaTamu','$no','$alamat','$action')");
	...
	mysqli_query($conn,"UPDATE tamuundangan SET nama='$namaTamu',noTelp='$no',alamat='$alamat', action='$action' WHERE idTamu='$idUpdate'");
	header("location:tambahTamuUndangan.php");
}
