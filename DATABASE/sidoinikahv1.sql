...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 23, 2021 at 02:47 AM
...
--
ALTER TABLE `data_wa`
  MODIFY `ID_MSG` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2147483743;
...
--
ALTER TABLE `tamuundangan`
  MODIFY `idTamu` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
